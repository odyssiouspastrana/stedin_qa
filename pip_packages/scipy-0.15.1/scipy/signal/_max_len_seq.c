/* Generated by Cython 0.20.2 (Debian 0.20.2-1) on Sun Jan 18 18:44:53 2015 */
...
#endif
#include <math.h>
#define __PYX_HAVE__scipy__signal___max_len_seq
#define __PYX_HAVE_API__scipy__signal___max_len_seq
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'scipy.signal._max_len_seq' */
...
#define __Pyx_MODULE_NAME "scipy.signal._max_len_seq"
int __pyx_module_is_main_scipy__signal___max_len_seq = 0;

/* Implementation of 'scipy.signal._max_len_seq' */
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_5scipy_6signal_12_max_len_seq_max_len_seq(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_nbits, PyObject *__pyx_v_state, PyObject *__pyx_v_length, PyObject *__pyx_v_taps); /* proto */
...
static char __pyx_k_c_taps[] = "c_taps";
static char __pyx_k_import[] = "__import__";
static char __pyx_k_length[] = "length";
static char __pyx_k_n_taps[] = "n_taps";
static char __pyx_k_unique[] = "unique";
static char __pyx_k_c_nbits[] = "c_nbits";
static char __pyx_k_c_state[] = "c_state";
static char __pyx_k_feedback[] = "feedback";
static char __pyx_k_mls_taps[] = "_mls_taps";
static char __pyx_k_ValueError[] = "ValueError";
static char __pyx_k_known_taps[] = "known_taps";
static char __pyx_k_max_len_seq[] = "max_len_seq";
...
static char __pyx_k_Tools_for_MLS_generation[] = "Tools for MLS generation";
static char __pyx_k_scipy_signal__max_len_seq[] = "scipy.signal._max_len_seq";
static char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static char __pyx_k_state_must_not_be_all_zeros[] = "state must not be all zeros";
static char __pyx_k_mnt_data_pauli_prj_scipy_scipy[] = "/mnt/data/pauli/prj/scipy/scipy/scipy/signal/_max_len_seq.pyx";
static char __pyx_k_unknown_dtype_code_in_numpy_pxd[] = "unknown dtype code in numpy.pxd (%d)";
static char __pyx_k_Format_string_allocated_too_shor[] = "Format string allocated too short, see comment in numpy.pxd";
static char __pyx_k_Non_native_byte_order_not_suppor[] = "Non-native byte order not supported";
static char __pyx_k_length_must_be_greater_than_or_e[] = "length must be greater than or equal to 0";
static char __pyx_k_nbits_must_be_between_s_and_s_if[] = "nbits must be between %s and %s if taps is None";
static char __pyx_k_ndarray_is_not_Fortran_contiguou[] = "ndarray is not Fortran contiguous";
static char __pyx_k_state_must_be_a_1_dimensional_ar[] = "state must be a 1-dimensional array of size nbits";
static char __pyx_k_taps_must_be_non_empty_with_valu[] = "taps must be non-empty with values between zero and nbits (inclusive)";
...
static PyObject *__pyx_n_s_c_nbits;
static PyObject *__pyx_n_s_c_state;
static PyObject *__pyx_n_s_c_taps;
...
static PyObject *__pyx_n_s_known_taps;
static PyObject *__pyx_n_s_length;
static PyObject *__pyx_kp_s_length_must_be_greater_than_or_e;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_max;
static PyObject *__pyx_n_s_max_len_seq;
static PyObject *__pyx_n_s_min;
static PyObject *__pyx_n_s_mls_taps;
...
static PyObject *__pyx_kp_s_nbits_must_be_between_s_and_s_if;
...
static PyObject *__pyx_n_s_scipy_signal__max_len_seq;
static PyObject *__pyx_n_s_seq;
static PyObject *__pyx_n_s_size;
static PyObject *__pyx_n_s_state;
static PyObject *__pyx_kp_s_state_must_be_a_1_dimensional_ar;
static PyObject *__pyx_kp_s_state_must_not_be_all_zeros;
static PyObject *__pyx_n_s_taps;
static PyObject *__pyx_kp_s_taps_must_be_non_empty_with_valu;
...
/* "scipy/signal/_max_len_seq.pyx":25
...
/* Python wrapper */
static PyObject *__pyx_pw_5scipy_6signal_12_max_len_seq_1max_len_seq(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5scipy_6signal_12_max_len_seq_max_len_seq[] = "\n    max_len_seq(nbits, state=None, length=None, taps=None)\n\n    Maximum Length Sequence (MLS) generator\n\n    Parameters\n    ----------\n    nbits : int\n        Number of bits to use. Length of the resulting sequence will\n        be ``(2**nbits) - 1``. Note that generating long sequences\n        (e.g., greater than ``nbits == 16``) can take a long time.\n    state : array_like, optional\n        If array, must be of length ``nbits``, and will be cast to binary\n        (bool) representation. If None, a seed of ones will be used,\n        producing a repeatable representation. If ``state`` is all\n        zeros, an error is raised as this is invalid. Default: None.\n    length : int | None, optional\n        Number of samples to compute. If None, the entire length\n        ``(2**nbits) - 1`` is computed.\n    taps : array_like, optional\n        Polynomial taps to use (e.g., ``[7, 6, 1]`` for an 8-bit sequence).\n        If None, taps will be automatically selected (for up to\n        ``nbits == 32``).\n\n    Returns\n    -------\n    seq : array\n        Resulting MLS sequence of 0's and 1's.\n    state : array\n        The final state of the shift register.\n\n    Notes\n    -----\n    The algorithm for MLS generation is generically described in:\n\n        http://en.wikipedia.org/wiki/Maximum_length_sequence\n\n    The default values for taps are specifically taken from the first\n    option listed for each value of ``nbits`` in:\n\n        http://www.newwaveinstruments.com/resources/articles/\n            m_sequence_linear_feedback_shift_register_lfsr.htm\n\n    .. versionadded:: 0.15.0\n    ";
static PyMethodDef __pyx_mdef_5scipy_6signal_12_max_len_seq_1max_len_seq = {__Pyx_NAMESTR("max_len_seq"), (PyCFunction)__pyx_pw_5scipy_6signal_12_max_len_seq_1max_len_seq, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_5scipy_6signal_12_max_len_seq_max_len_seq)};
static PyObject *__pyx_pw_5scipy_6signal_12_max_len_seq_1max_len_seq(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyObject *__pyx_v_nbits = 0;
  PyObject *__pyx_v_state = 0;
  PyObject *__pyx_v_length = 0;
  PyObject *__pyx_v_taps = 0;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("max_len_seq (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_nbits,&__pyx_n_s_state,&__pyx_n_s_length,&__pyx_n_s_taps,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nbits)) != 0)) kw_args--;
        ...
        case  3:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_taps);
          if (value) { values[3] = value; kw_args--; }
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "max_len_seq") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
    ...
    __pyx_v_nbits = values[0];
    __pyx_v_state = values[1];
    __pyx_v_length = values[2];
    __pyx_v_taps = values[3];
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("max_len_seq", 0, 1, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("scipy.signal._max_len_seq.max_len_seq", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5scipy_6signal_12_max_len_seq_max_len_seq(__pyx_self, __pyx_v_nbits, __pyx_v_state, __pyx_v_length, __pyx_v_taps);
...
static PyObject *__pyx_pf_5scipy_6signal_12_max_len_seq_max_len_seq(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_nbits, PyObject *__pyx_v_state, PyObject *__pyx_v_length, PyObject *__pyx_v_taps) {
  PyObject *__pyx_v_known_taps = NULL;
  PyObject *__pyx_v_n_max = NULL;
  PyArrayObject *__pyx_v_c_taps = 0;
  PyArrayObject *__pyx_v_c_state = 0;
  Py_ssize_t __pyx_v_c_nbits;
  Py_ssize_t __pyx_v_n_out;
  Py_ssize_t __pyx_v_n_taps;
  Py_ssize_t __pyx_v_idx;
  CYTHON_UNUSED Py_ssize_t __pyx_v_fidx;
  __pyx_t_5numpy_int8_t __pyx_v_feedback;
  PyArrayObject *__pyx_v_seq = 0;
  Py_ssize_t __pyx_v_ii;
  Py_ssize_t __pyx_v_ti;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_c_state;
  __Pyx_Buffer __pyx_pybuffer_c_state;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_c_taps;
  __Pyx_Buffer __pyx_pybuffer_c_taps;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("max_len_seq", 0);
  __Pyx_INCREF(__pyx_v_state);
  __Pyx_INCREF(__pyx_v_length);
  __Pyx_INCREF(__pyx_v_taps);
  __pyx_pybuffer_c_taps.pybuffer.buf = NULL;
  __pyx_pybuffer_c_taps.refcount = 0;
  __pyx_pybuffernd_c_taps.data = NULL;
  __pyx_pybuffernd_c_taps.rcbuffer = &__pyx_pybuffer_c_taps;
  __pyx_pybuffer_c_state.pybuffer.buf = NULL;
  __pyx_pybuffer_c_state.refcount = 0;
  __pyx_pybuffernd_c_state.data = NULL;
  __pyx_pybuffernd_c_state.rcbuffer = &__pyx_pybuffer_c_state;
  ...
  /* "scipy/signal/_max_len_seq.pyx":71
 *     .. versionadded:: 0.15.0
 *     """
 *     if taps is None:             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = (__pyx_v_taps == Py_None);
  __pyx_t_2 = (__pyx_t_1 != 0);
  if (__pyx_t_2) {

    /* "scipy/signal/_max_len_seq.pyx":72
 *     """
 *     if taps is None:
 *         if nbits not in _mls_taps:             # <<<<<<<<<<<<<<
 *             known_taps = np.array(list(_mls_taps.keys()))
 ...
 */
    __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_mls_taps); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_2 = (__Pyx_PySequence_Contains(__pyx_v_nbits, __pyx_t_3, Py_NE)); if (unlikely(__pyx_t_2 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 72; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_1 = (__pyx_t_2 != 0);
    if (__pyx_t_1) {

      /* "scipy/signal/_max_len_seq.pyx":73
 *     if taps is None:
 *         if nbits not in _mls_taps:
 *             known_taps = np.array(list(_mls_taps.keys()))             # <<<<<<<<<<<<<<
 *             raise ValueError('nbits must be between %s and %s if taps is None'
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_array); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_mls_taps); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_keys); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_empty_tuple, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __pyx_t_3 = 0;
      __pyx_t_3 = __Pyx_PyObject_Call(((PyObject *)((PyObject*)(&PyList_Type))), __pyx_t_5, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_5 = PyTuple_New(1); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      ...
      __Pyx_GIVEREF(__pyx_t_3);
      __pyx_t_3 = 0;
      __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_v_known_taps = __pyx_t_3;
      __pyx_t_3 = 0;

      /* "scipy/signal/_max_len_seq.pyx":75
 *             known_taps = np.array(list(_mls_taps.keys()))
 *             raise ValueError('nbits must be between %s and %s if taps is None'
 *                              % (known_taps.min(), known_taps.max()))             # <<<<<<<<<<<<<<
 ...
 *     else:
 */
      __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_known_taps, __pyx_n_s_min); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_empty_tuple, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_v_known_taps, __pyx_n_s_max); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      ...
      __pyx_t_5 = 0;
      __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyString_Format(__pyx_kp_s_nbits_must_be_between_s_and_s_if, __pyx_t_3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;

      /* "scipy/signal/_max_len_seq.pyx":74
 *         if nbits not in _mls_taps:
 *             known_taps = np.array(list(_mls_taps.keys()))
 *             raise ValueError('nbits must be between %s and %s if taps is None'             # <<<<<<<<<<<<<<
 *                              % (known_taps.min(), known_taps.max()))
 ...
 */
      ...
      __Pyx_GIVEREF(__pyx_t_4);
      __pyx_t_4 = 0;
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_t_3, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 74; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    /* "scipy/signal/_max_len_seq.pyx":76
 *             raise ValueError('nbits must be between %s and %s if taps is None'
 *                              % (known_taps.min(), known_taps.max()))
 *         taps = np.array(_mls_taps[nbits], np.intp)             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_array); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_mls_taps); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = PyObject_GetItem(__pyx_t_4, __pyx_v_nbits); if (unlikely(__pyx_t_5 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_intp); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __pyx_t_5 = 0;
    __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_4, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 76; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF_SET(__pyx_v_taps, __pyx_t_6);
    __pyx_t_6 = 0;
    goto __pyx_L3;
  }
  /*else*/ {

    /* "scipy/signal/_max_len_seq.pyx":78
 *         taps = np.array(_mls_taps[nbits], np.intp)
 *     else:
 *         taps = np.unique(np.array(taps, np.intp))[::-1]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_unique); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_array); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_intp); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_INCREF(__pyx_v_taps);
    PyTuple_SET_ITEM(__pyx_t_6, 0, __pyx_v_taps);
    __Pyx_GIVEREF(__pyx_v_taps);
    PyTuple_SET_ITEM(__pyx_t_6, 1, __pyx_t_5);
    __Pyx_GIVEREF(__pyx_t_5);
    __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_6, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    ...
    __Pyx_GIVEREF(__pyx_t_5);
    __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_6, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = PyObject_GetItem(__pyx_t_5, __pyx_slice_); if (unlikely(__pyx_t_6 == NULL)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF_SET(__pyx_v_taps, __pyx_t_6);
    __pyx_t_6 = 0;

    /* "scipy/signal/_max_len_seq.pyx":79
 *     else:
 *         taps = np.unique(np.array(taps, np.intp))[::-1]
 *         if np.any(taps < 0) or np.any(taps > nbits) or taps.size < 1:             # <<<<<<<<<<<<<<
 *             raise ValueError('taps must be non-empty with values between '
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_6);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_any); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __pyx_t_6 = PyObject_RichCompare(__pyx_v_taps, __pyx_int_0, Py_LT); __Pyx_XGOTREF(__pyx_t_6); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __Pyx_GIVEREF(__pyx_t_6);
    __pyx_t_6 = 0;
    __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_4, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_t_6); if (unlikely(__pyx_t_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    if (!__pyx_t_1) {
      __pyx_t_6 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_any); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      __pyx_t_6 = PyObject_RichCompare(__pyx_v_taps, __pyx_v_nbits, Py_GT); __Pyx_XGOTREF(__pyx_t_6); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __Pyx_GIVEREF(__pyx_t_6);
      __pyx_t_6 = 0;
      __pyx_t_6 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, NULL); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_6);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_6); if (unlikely(__pyx_t_2 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
      if (!__pyx_t_2) {
        __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_v_taps, __pyx_n_s_size); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_6);
        __pyx_t_5 = PyObject_RichCompare(__pyx_t_6, __pyx_int_1, Py_LT); __Pyx_XGOTREF(__pyx_t_5); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
        __pyx_t_7 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_7 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 79; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
        __pyx_t_8 = __pyx_t_7;
      } else {
        __pyx_t_8 = __pyx_t_2;
    ...
    if (__pyx_t_2) {
      ...
      /* "scipy/signal/_max_len_seq.pyx":80
 *         taps = np.unique(np.array(taps, np.intp))[::-1]
 *         if np.any(taps < 0) or np.any(taps > nbits) or taps.size < 1:
 *             raise ValueError('taps must be non-empty with values between '             # <<<<<<<<<<<<<<
 *                              'zero and nbits (inclusive)')
 ...
 */
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__2, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
    ...
    /* "scipy/signal/_max_len_seq.pyx":82
 *             raise ValueError('taps must be non-empty with values between '
 *                              'zero and nbits (inclusive)')
 *         taps = np.ascontiguousarray(taps)  # needed for Cython             # <<<<<<<<<<<<<<
 *     n_max = (2**nbits) - 1
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_ascontiguousarray); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_INCREF(__pyx_v_taps);
    PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_v_taps);
    __Pyx_GIVEREF(__pyx_v_taps);
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 82; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF_SET(__pyx_v_taps, __pyx_t_4);
    __pyx_t_4 = 0;
  }
  __pyx_L3:;

  /* "scipy/signal/_max_len_seq.pyx":83
 *                              'zero and nbits (inclusive)')
 *         taps = np.ascontiguousarray(taps)  # needed for Cython
 *     n_max = (2**nbits) - 1             # <<<<<<<<<<<<<<
 *     if length is None:
 *         length = n_max
 */
  __pyx_t_4 = PyNumber_Power(__pyx_int_2, __pyx_v_nbits, Py_None); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = PyNumber_Subtract(__pyx_t_4, __pyx_int_1); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 83; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_n_max = __pyx_t_5;
  __pyx_t_5 = 0;

  /* "scipy/signal/_max_len_seq.pyx":84
 *         taps = np.ascontiguousarray(taps)  # needed for Cython
 *     n_max = (2**nbits) - 1
 *     if length is None:             # <<<<<<<<<<<<<<
 *         length = n_max
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "scipy/signal/_max_len_seq.pyx":85
 *     n_max = (2**nbits) - 1
 *     if length is None:
 *         length = n_max             # <<<<<<<<<<<<<<
 *     else:
 *         length = int(length)
 */
    __Pyx_INCREF(__pyx_v_n_max);
    __Pyx_DECREF_SET(__pyx_v_length, __pyx_v_n_max);
    goto __pyx_L6;
  }
  /*else*/ {

    /* "scipy/signal/_max_len_seq.pyx":87
 *         length = n_max
 *     else:
 *         length = int(length)             # <<<<<<<<<<<<<<
 *         if length < 0:
 ...
 */
    __pyx_t_5 = PyNumber_Int(__pyx_v_length); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 87; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF_SET(__pyx_v_length, __pyx_t_5);
    __pyx_t_5 = 0;

    /* "scipy/signal/_max_len_seq.pyx":88
 *     else:
 *         length = int(length)
 *         if length < 0:             # <<<<<<<<<<<<<<
 *             raise ValueError('length must be greater than or equal to 0')
 ...
 */
    __pyx_t_5 = PyObject_RichCompare(__pyx_v_length, __pyx_int_0, Py_LT); __Pyx_XGOTREF(__pyx_t_5); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 88; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    if (__pyx_t_1) {
      ...
      /* "scipy/signal/_max_len_seq.pyx":89
 *         length = int(length)
 *         if length < 0:
 *             raise ValueError('length must be greater than or equal to 0')             # <<<<<<<<<<<<<<
 *     # We use int8 instead of bool here because numpy arrays of bools
 ...
 */
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_Raise(__pyx_t_5, 0, 0, 0);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  /* "scipy/signal/_max_len_seq.pyx":92
 *     # We use int8 instead of bool here because numpy arrays of bools
 *     # don't seem to work nicely with Cython
 *     if state is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_2) {
    ...
    /* "scipy/signal/_max_len_seq.pyx":93
 *     # don't seem to work nicely with Cython
 *     if state is None:
 *         state = np.ones(nbits, dtype=np.int8, order='c')             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_ones); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    ...
    PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_v_nbits);
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_int8); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_dtype, __pyx_t_9) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    if (PyDict_SetItem(__pyx_t_6, __pyx_n_s_order, __pyx_n_s_c) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, __pyx_t_6); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 93; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  /*else*/ {
    ...
    /* "scipy/signal/_max_len_seq.pyx":96
 *     else:
 *         # makes a copy if need be, ensuring it's 0's and 1's
 ...
 */
    __pyx_t_9 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    ...
    __Pyx_GOTREF(__pyx_t_5);
    if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, ((PyObject*)&PyBool_Type)) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_6, __pyx_t_9, __pyx_t_5); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_astype); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_int8); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __pyx_t_9 = 0;
    __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_4, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 96; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_DECREF_SET(__pyx_v_state, __pyx_t_9);
  ...
  /* "scipy/signal/_max_len_seq.pyx":97
 *         # makes a copy if need be, ensuring it's 0's and 1's
 *         state = np.array(state, dtype=bool, order='c').astype(np.int8)
 *     if state.ndim != 1 or state.size != nbits:             # <<<<<<<<<<<<<<
 *         raise ValueError('state must be a 1-dimensional array of size nbits')
 *     if np.all(state == 0):
 */
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_v_state, __pyx_n_s_ndim); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_4 = PyObject_RichCompare(__pyx_t_9, __pyx_int_1, Py_NE); __Pyx_XGOTREF(__pyx_t_4); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (!__pyx_t_2) {
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_v_state, __pyx_n_s_size); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_9 = PyObject_RichCompare(__pyx_t_4, __pyx_v_nbits, Py_NE); __Pyx_XGOTREF(__pyx_t_9); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_1 = __Pyx_PyObject_IsTrue(__pyx_t_9); if (unlikely(__pyx_t_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 97; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __pyx_t_8 = __pyx_t_1;
  } else {
    __pyx_t_8 = __pyx_t_2;
  ...
  if (__pyx_t_8) {
    ...
    /* "scipy/signal/_max_len_seq.pyx":98
 *         state = np.array(state, dtype=bool, order='c').astype(np.int8)
 *     if state.ndim != 1 or state.size != nbits:
 *         raise ValueError('state must be a 1-dimensional array of size nbits')             # <<<<<<<<<<<<<<
 *     if np.all(state == 0):
 ...
 */
    __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__4, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
  ...
  /* "scipy/signal/_max_len_seq.pyx":99
 *     if state.ndim != 1 or state.size != nbits:
 *         raise ValueError('state must be a 1-dimensional array of size nbits')
 *     if np.all(state == 0):             # <<<<<<<<<<<<<<
 *         raise ValueError('state must not be all zeros')
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_all); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = PyObject_RichCompare(__pyx_v_state, __pyx_int_0, Py_EQ); __Pyx_XGOTREF(__pyx_t_9); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __Pyx_GIVEREF(__pyx_t_9);
  __pyx_t_9 = 0;
  __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_4, __pyx_t_5, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_8 = __Pyx_PyObject_IsTrue(__pyx_t_9); if (unlikely(__pyx_t_8 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 99; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  if (__pyx_t_8) {

    /* "scipy/signal/_max_len_seq.pyx":100
 *         raise ValueError('state must be a 1-dimensional array of size nbits')
 *     if np.all(state == 0):
 *         raise ValueError('state must not be all zeros')             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_9 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple__5, NULL); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_9);
    __Pyx_Raise(__pyx_t_9, 0, 0, 0);
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  ...
  /* "scipy/signal/_max_len_seq.pyx":104
 *     # Here we compute MLS using a shift register, indexed using a ring buffer
 ...
 */
  if (!(likely(((__pyx_v_taps) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_taps, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_9 = __pyx_v_taps;
  __Pyx_INCREF(__pyx_t_9);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_c_taps.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_9), &__Pyx_TypeInfo_Py_ssize_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_c_taps = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_c_taps.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 104; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_c_taps.diminfo[0].strides = __pyx_pybuffernd_c_taps.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_c_taps.diminfo[0].shape = __pyx_pybuffernd_c_taps.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_v_c_taps = ((PyArrayObject *)__pyx_t_9);
  __pyx_t_9 = 0;

  /* "scipy/signal/_max_len_seq.pyx":105
 *     # technique (faster than using something like np.roll to shift)
 *     cdef np.ndarray[Py_ssize_t, ndim=1, mode='c'] c_taps = taps
 *     cdef np.ndarray[np.int8_t, ndim=1, mode='c'] c_state = state             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t c_nbits = nbits
 ...
 */
  if (!(likely(((__pyx_v_state) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_state, __pyx_ptype_5numpy_ndarray))))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_9 = __pyx_v_state;
  __Pyx_INCREF(__pyx_t_9);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_c_state.rcbuffer->pybuffer, (PyObject*)((PyArrayObject *)__pyx_t_9), &__Pyx_TypeInfo_nn___pyx_t_5numpy_int8_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_c_state = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_c_state.rcbuffer->pybuffer.buf = NULL;
      {__pyx_filename = __pyx_f[0]; __pyx_lineno = 105; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    } else {__pyx_pybuffernd_c_state.diminfo[0].strides = __pyx_pybuffernd_c_state.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_c_state.diminfo[0].shape = __pyx_pybuffernd_c_state.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_v_c_state = ((PyArrayObject *)__pyx_t_9);
  __pyx_t_9 = 0;

  /* "scipy/signal/_max_len_seq.pyx":106
 *     cdef np.ndarray[Py_ssize_t, ndim=1, mode='c'] c_taps = taps
 *     cdef np.ndarray[np.int8_t, ndim=1, mode='c'] c_state = state
 *     cdef Py_ssize_t c_nbits = nbits             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t n_out = length
 ...
 */
  __pyx_t_10 = __Pyx_PyIndex_AsSsize_t(__pyx_v_nbits); if (unlikely((__pyx_t_10 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 106; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_c_nbits = __pyx_t_10;

  /* "scipy/signal/_max_len_seq.pyx":107
 *     cdef np.ndarray[np.int8_t, ndim=1, mode='c'] c_state = state
 *     cdef Py_ssize_t c_nbits = nbits
 *     cdef Py_ssize_t n_out = length             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t n_taps = taps.size
 ...
 */
  __pyx_t_10 = __Pyx_PyIndex_AsSsize_t(__pyx_v_length); if (unlikely((__pyx_t_10 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 107; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_n_out = __pyx_t_10;

  /* "scipy/signal/_max_len_seq.pyx":108
 *     cdef Py_ssize_t c_nbits = nbits
 *     cdef Py_ssize_t n_out = length
 *     cdef Py_ssize_t n_taps = taps.size             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t idx = 0
 ...
 */
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_v_taps, __pyx_n_s_size); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 108; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_10 = __Pyx_PyIndex_AsSsize_t(__pyx_t_9); if (unlikely((__pyx_t_10 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 108; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_v_n_taps = __pyx_t_10;

  /* "scipy/signal/_max_len_seq.pyx":109
 *     cdef Py_ssize_t n_out = length
 *     cdef Py_ssize_t n_taps = taps.size
 *     cdef Py_ssize_t idx = 0             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t fidx = 0
 ...
 */
  ...
  /* "scipy/signal/_max_len_seq.pyx":110
 *     cdef Py_ssize_t n_taps = taps.size
 *     cdef Py_ssize_t idx = 0
 *     cdef Py_ssize_t fidx = 0             # <<<<<<<<<<<<<<
 *     cdef np.int8_t feedback
 ...
 */
  ...
  /* "scipy/signal/_max_len_seq.pyx":113
 *     cdef np.int8_t feedback
 *     cdef np.ndarray[np.int8_t, ndim=1, mode='c'] seq = \
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_empty); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = PyInt_FromSsize_t(__pyx_v_n_out); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_int8); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (PyDict_SetItem(__pyx_t_9, __pyx_n_s_dtype, __pyx_t_3) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_9, __pyx_n_s_order, __pyx_n_s_c) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_4, __pyx_t_9); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 113; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_seq.rcbuffer->pybuffer, (PyObject*)__pyx_t_11, &__Pyx_TypeInfo_nn___pyx_t_5numpy_int8_t, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
    ...
    } else {__pyx_pybuffernd_seq.diminfo[0].strides = __pyx_pybuffernd_seq.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_seq.diminfo[0].shape = __pyx_pybuffernd_seq.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_11 = 0;
  __pyx_v_seq = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "scipy/signal/_max_len_seq.pyx":114
 *     cdef np.ndarray[np.int8_t, ndim=1, mode='c'] seq = \
 *         np.empty(n_out, dtype=np.int8, order='c')
 *     for ii in range(n_out):             # <<<<<<<<<<<<<<
 *         feedback = c_state[idx]
 ...
 */
    ...
    __pyx_v_feedback = (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_int8_t *, __pyx_pybuffernd_c_state.rcbuffer->pybuffer.buf, __pyx_t_13, __pyx_pybuffernd_c_state.diminfo[0].strides));

    /* "scipy/signal/_max_len_seq.pyx":116
 *     for ii in range(n_out):
 *         feedback = c_state[idx]
 *         seq[ii] = feedback             # <<<<<<<<<<<<<<
 *         for ti in range(n_taps):
 ...
 */
    ...
    *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_int8_t *, __pyx_pybuffernd_seq.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_seq.diminfo[0].strides) = __pyx_v_feedback;

    /* "scipy/signal/_max_len_seq.pyx":117
 *         feedback = c_state[idx]
 *         seq[ii] = feedback
 *         for ti in range(n_taps):             # <<<<<<<<<<<<<<
 *             feedback ^= c_state[(c_taps[ti] + idx) % c_nbits]
 ...
 */
    __pyx_t_15 = __pyx_v_n_taps;
    for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
      __pyx_v_ti = __pyx_t_16;

      /* "scipy/signal/_max_len_seq.pyx":118
 *         seq[ii] = feedback
 *         for ti in range(n_taps):
 *             feedback ^= c_state[(c_taps[ti] + idx) % c_nbits]             # <<<<<<<<<<<<<<
 *         c_state[idx] = feedback
 ...
 */
      ...
      __pyx_t_18 = (((*__Pyx_BufPtrCContig1d(Py_ssize_t *, __pyx_pybuffernd_c_taps.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_c_taps.diminfo[0].strides)) + __pyx_v_idx) % __pyx_v_c_nbits);
      __pyx_v_feedback = (__pyx_v_feedback ^ (*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_int8_t *, __pyx_pybuffernd_c_state.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_c_state.diminfo[0].strides)));
    }

    /* "scipy/signal/_max_len_seq.pyx":119
 *         for ti in range(n_taps):
 *             feedback ^= c_state[(c_taps[ti] + idx) % c_nbits]
 *         c_state[idx] = feedback             # <<<<<<<<<<<<<<
 *         idx = (idx + 1) % c_nbits
 ...
 */
    ...
    *__Pyx_BufPtrCContig1d(__pyx_t_5numpy_int8_t *, __pyx_pybuffernd_c_state.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_c_state.diminfo[0].strides) = __pyx_v_feedback;

    /* "scipy/signal/_max_len_seq.pyx":120
 *             feedback ^= c_state[(c_taps[ti] + idx) % c_nbits]
 *         c_state[idx] = feedback
 *         idx = (idx + 1) % c_nbits             # <<<<<<<<<<<<<<
 *     # state must be rolled s.t. next run, when idx==0, it's in the right place
 ...
 */
    __pyx_v_idx = ((__pyx_v_idx + 1) % __pyx_v_c_nbits);
  }

  /* "scipy/signal/_max_len_seq.pyx":122
 *         idx = (idx + 1) % c_nbits
 *     # state must be rolled s.t. next run, when idx==0, it's in the right place
 *     state = np.roll(state, -idx, axis=0)             # <<<<<<<<<<<<<<
 *     return seq, state
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_roll); if (unlikely(!__pyx_t_9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyInt_FromSsize_t((-__pyx_v_idx)); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_axis, __pyx_int_0) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 122; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "scipy/signal/_max_len_seq.pyx":123
 *     # state must be rolled s.t. next run, when idx==0, it's in the right place
 *     state = np.roll(state, -idx, axis=0)
 *     return seq, state             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_c_state.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_c_taps.rcbuffer->pybuffer);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_seq.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF(__pyx_v_known_taps);
  __Pyx_XDECREF(__pyx_v_n_max);
  __Pyx_XDECREF((PyObject *)__pyx_v_c_taps);
  __Pyx_XDECREF((PyObject *)__pyx_v_c_state);
  __Pyx_XDECREF((PyObject *)__pyx_v_seq);
  __Pyx_XDECREF(__pyx_v_state);
  __Pyx_XDECREF(__pyx_v_length);
  __Pyx_XDECREF(__pyx_v_taps);
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    __Pyx_NAMESTR("_max_len_seq"),
    __Pyx_DOCSTR(__pyx_k_Tools_for_MLS_generation), /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_c_nbits, __pyx_k_c_nbits, sizeof(__pyx_k_c_nbits), 0, 0, 1, 1},
  {&__pyx_n_s_c_state, __pyx_k_c_state, sizeof(__pyx_k_c_state), 0, 0, 1, 1},
  {&__pyx_n_s_c_taps, __pyx_k_c_taps, sizeof(__pyx_k_c_taps), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_known_taps, __pyx_k_known_taps, sizeof(__pyx_k_known_taps), 0, 0, 1, 1},
  {&__pyx_n_s_length, __pyx_k_length, sizeof(__pyx_k_length), 0, 0, 1, 1},
  {&__pyx_kp_s_length_must_be_greater_than_or_e, __pyx_k_length_must_be_greater_than_or_e, sizeof(__pyx_k_length_must_be_greater_than_or_e), 0, 0, 1, 0},
  {&__pyx_n_s_main, __pyx_k_main, sizeof(__pyx_k_main), 0, 0, 1, 1},
  {&__pyx_n_s_max, __pyx_k_max, sizeof(__pyx_k_max), 0, 0, 1, 1},
  {&__pyx_n_s_max_len_seq, __pyx_k_max_len_seq, sizeof(__pyx_k_max_len_seq), 0, 0, 1, 1},
  {&__pyx_n_s_min, __pyx_k_min, sizeof(__pyx_k_min), 0, 0, 1, 1},
  {&__pyx_n_s_mls_taps, __pyx_k_mls_taps, sizeof(__pyx_k_mls_taps), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_nbits_must_be_between_s_and_s_if, __pyx_k_nbits_must_be_between_s_and_s_if, sizeof(__pyx_k_nbits_must_be_between_s_and_s_if), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_scipy_signal__max_len_seq, __pyx_k_scipy_signal__max_len_seq, sizeof(__pyx_k_scipy_signal__max_len_seq), 0, 0, 1, 1},
  {&__pyx_n_s_seq, __pyx_k_seq, sizeof(__pyx_k_seq), 0, 0, 1, 1},
  {&__pyx_n_s_size, __pyx_k_size, sizeof(__pyx_k_size), 0, 0, 1, 1},
  {&__pyx_n_s_state, __pyx_k_state, sizeof(__pyx_k_state), 0, 0, 1, 1},
  {&__pyx_kp_s_state_must_be_a_1_dimensional_ar, __pyx_k_state_must_be_a_1_dimensional_ar, sizeof(__pyx_k_state_must_be_a_1_dimensional_ar), 0, 0, 1, 0},
  {&__pyx_kp_s_state_must_not_be_all_zeros, __pyx_k_state_must_not_be_all_zeros, sizeof(__pyx_k_state_must_not_be_all_zeros), 0, 0, 1, 0},
  {&__pyx_n_s_taps, __pyx_k_taps, sizeof(__pyx_k_taps), 0, 0, 1, 1},
  {&__pyx_kp_s_taps_must_be_non_empty_with_valu, __pyx_k_taps_must_be_non_empty_with_valu, sizeof(__pyx_k_taps_must_be_non_empty_with_valu), 0, 0, 1, 0},
 ...
 *             raise ValueError('taps must be non-empty with values between '
 */
  __pyx_slice_ = PySlice_New(Py_None, Py_None, __pyx_int_neg_1); if (unlikely(!__pyx_slice_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 78; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         taps = np.ascontiguousarray(taps)  # needed for Cython
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_kp_s_taps_must_be_non_empty_with_valu); if (unlikely(!__pyx_tuple__2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 80; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     # don't seem to work nicely with Cython
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_s_length_must_be_greater_than_or_e); if (unlikely(!__pyx_tuple__3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 89; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *         raise ValueError('state must not be all zeros')
 */
  __pyx_tuple__4 = PyTuple_Pack(1, __pyx_kp_s_state_must_be_a_1_dimensional_ar); if (unlikely(!__pyx_tuple__4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 98; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     # Here we compute MLS using a shift register, indexed using a ring buffer
 */
  __pyx_tuple__5 = PyTuple_Pack(1, __pyx_kp_s_state_must_not_be_all_zeros); if (unlikely(!__pyx_tuple__5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 100; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     max_len_seq(nbits, state=None, length=None, taps=None)
 */
  __pyx_tuple__12 = PyTuple_Pack(17, __pyx_n_s_nbits, __pyx_n_s_state, __pyx_n_s_length, __pyx_n_s_taps, __pyx_n_s_known_taps, __pyx_n_s_n_max, __pyx_n_s_c_taps, __pyx_n_s_c_state, __pyx_n_s_c_nbits, __pyx_n_s_n_out, __pyx_n_s_n_taps, __pyx_n_s_idx, __pyx_n_s_fidx, __pyx_n_s_feedback, __pyx_n_s_seq, __pyx_n_s_ii, __pyx_n_s_ti); if (unlikely(!__pyx_tuple__12)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_tuple__12);
  __Pyx_GIVEREF(__pyx_tuple__12);
  __pyx_codeobj__13 = (PyObject*)__Pyx_PyCode_New(4, 0, 17, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__12, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_mnt_data_pauli_prj_scipy_scipy, __pyx_n_s_max_len_seq, 25, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#else
PyMODINIT_FUNC PyInit__max_len_seq(void); /*proto*/
PyMODINIT_FUNC PyInit__max_len_seq(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__max_len_seq(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_max_len_seq"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_Tools_for_MLS_generation), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_scipy__signal___max_len_seq) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "scipy.signal._max_len_seq")) {
      if (unlikely(PyDict_SetItemString(modules, "scipy.signal._max_len_seq", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "scipy/signal/_max_len_seq.pyx":6
 ...
 */
  ...
  /* "scipy/signal/_max_len_seq.pyx":10
 * cimport cython
 * 
 * __all__ = ['max_len_seq']             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(__pyx_n_s_max_len_seq);
  PyList_SET_ITEM(__pyx_t_1, 0, __pyx_n_s_max_len_seq);
  __Pyx_GIVEREF(__pyx_n_s_max_len_seq);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all_2, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 10; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "scipy/signal/_max_len_seq.pyx":14
 * 
 ...
 */
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_3, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_int_3);
  __Pyx_GIVEREF(__pyx_int_3);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_5, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_6, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_7, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_GIVEREF(__pyx_int_1);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_8, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/signal/_max_len_seq.pyx":15
 * # These are definitions of linear shift register taps for use in max_len_seq()
 * _mls_taps = {2: [1], 3: [2], 4: [3], 5: [3], 6: [5], 7: [6], 8: [7, 6, 1],
 *              9: [5], 10: [7], 11: [9], 12: [11, 10, 4], 13: [12, 11, 8],             # <<<<<<<<<<<<<<
 *              14: [13, 12, 2], 15: [14], 16: [15, 13, 4], 17: [14],
 ...
 */
  ...
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_int_5);
  __Pyx_GIVEREF(__pyx_int_5);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_9, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_INCREF(__pyx_int_7);
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_int_7);
  __Pyx_GIVEREF(__pyx_int_7);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_10, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_11, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_12, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_13, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/signal/_max_len_seq.pyx":16
 * _mls_taps = {2: [1], 3: [2], 4: [3], 5: [3], 6: [5], 7: [6], 8: [7, 6, 1],
 *              9: [5], 10: [7], 11: [9], 12: [11, 10, 4], 13: [12, 11, 8],
 *              14: [13, 12, 2], 15: [14], 16: [15, 13, 4], 17: [14],             # <<<<<<<<<<<<<<
 *              18: [11], 19: [18, 17, 14], 20: [17], 21: [19], 22: [21],
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_int_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_14, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_15, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  PyList_SET_ITEM(__pyx_t_2, 2, __pyx_int_4);
  __Pyx_GIVEREF(__pyx_int_4);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_16, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_INCREF(__pyx_int_14);
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_int_14);
  __Pyx_GIVEREF(__pyx_int_14);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_17, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/signal/_max_len_seq.pyx":17
 *              9: [5], 10: [7], 11: [9], 12: [11, 10, 4], 13: [12, 11, 8],
 *              14: [13, 12, 2], 15: [14], 16: [15, 13, 4], 17: [14],
 *              18: [11], 19: [18, 17, 14], 20: [17], 21: [19], 22: [21],             # <<<<<<<<<<<<<<
 *              23: [18], 24: [23, 22, 17], 25: [22], 26: [25, 24, 20],
 ...
 */
  ...
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_int_11);
  __Pyx_GIVEREF(__pyx_int_11);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_18, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_GIVEREF(__pyx_int_14);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_19, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_INCREF(__pyx_int_17);
  ...
  __Pyx_GIVEREF(__pyx_int_17);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_20, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_21, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 17; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_INCREF(__pyx_int_21);
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_int_21);
  __Pyx_GIVEREF(__pyx_int_21);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_22, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/signal/_max_len_seq.pyx":18
 *              14: [13, 12, 2], 15: [14], 16: [15, 13, 4], 17: [14],
 *              18: [11], 19: [18, 17, 14], 20: [17], 21: [19], 22: [21],
 *              23: [18], 24: [23, 22, 17], 25: [22], 26: [25, 24, 20],             # <<<<<<<<<<<<<<
 *              27: [26, 25, 22], 28: [25], 29: [27], 30: [29, 28, 7],
 ...
 */
  ...
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_int_18);
  __Pyx_GIVEREF(__pyx_int_18);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_23, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_INCREF(__pyx_int_17);
  PyList_SET_ITEM(__pyx_t_2, 2, __pyx_int_17);
  __Pyx_GIVEREF(__pyx_int_17);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_24, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_INCREF(__pyx_int_22);
  ...
  __Pyx_GIVEREF(__pyx_int_22);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_25, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 18; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_26, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/signal/_max_len_seq.pyx":19
 *              18: [11], 19: [18, 17, 14], 20: [17], 21: [19], 22: [21],
 *              23: [18], 24: [23, 22, 17], 25: [22], 26: [25, 24, 20],
 *              27: [26, 25, 22], 28: [25], 29: [27], 30: [29, 28, 7],             # <<<<<<<<<<<<<<
 *              31: [28], 32: [31, 30, 10]}
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_int_22);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_27, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  PyList_SET_ITEM(__pyx_t_2, 0, __pyx_int_25);
  __Pyx_GIVEREF(__pyx_int_25);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_28, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(1); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_29, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyList_New(3); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GIVEREF(__pyx_int_7);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_30, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "scipy/signal/_max_len_seq.pyx":20
 *              23: [18], 24: [23, 22, 17], 25: [22], 26: [25, 24, 20],
 *              27: [26, 25, 22], 28: [25], 29: [27], 30: [29, 28, 7],
 *              31: [28], 32: [31, 30, 10]}             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GIVEREF(__pyx_int_28);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_31, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __Pyx_GIVEREF(__pyx_int_10);
  if (PyDict_SetItem(__pyx_t_1, __pyx_int_32, __pyx_t_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_mls_taps, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     max_len_seq(nbits, state=None, length=None, taps=None)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_6signal_12_max_len_seq_1max_len_seq, NULL, __pyx_n_s_scipy_signal__max_len_seq); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_max_len_seq, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 25; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "scipy/signal/_max_len_seq.pyx":1
 * # Author: Eric Larson             # <<<<<<<<<<<<<<
 * # 2014
 * 
 */
 ...
 */
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init scipy.signal._max_len_seq", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init scipy.signal._max_len_seq");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
