/* Generated by Cython 0.20.2 (Debian 0.20.2-1) on Sun Jan 18 18:44:52 2015 */
...
static char __pyx_k_mnt_data_pauli_prj_scipy_scipy[] = "/mnt/data/pauli/prj/scipy/scipy/scipy/signal/_spectral.pyx";
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_Call(__pyx_builtin_ValueError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "scipy/signal/_spectral.pyx":132
 * 
 *     # Create empty array for output periodogram
 ...
 */
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_Py_intptr_t((__pyx_v_freqs->dimensions[0])); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 132; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_float64); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 132; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "scipy/signal/_spectral.pyx":139
 ...
 */
    ...
    /* "scipy/signal/_spectral.pyx":147
 *         cs = 0.
 * 
 *         for j in range(x.shape[0]):             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_18 = (2.0 * (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_freqs.rcbuffer->pybuffer.buf, __pyx_t_10, __pyx_pybuffernd_freqs.diminfo[0].strides)));
    ...
    __pyx_v_tau = (__pyx_t_17 / __pyx_t_18);
 ...
 */
    ...
    if (__pyx_t_19 < 0) __pyx_t_19 += __pyx_pybuffernd_freqs.diminfo[0].shape;
    __pyx_v_c_tau = cos(((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_freqs.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_freqs.diminfo[0].strides)) * __pyx_v_tau));
 ...
 */
    ...
    __pyx_v_s_tau = sin(((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_freqs.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_freqs.diminfo[0].strides)) * __pyx_v_tau));
 ...
 */
    __pyx_t_21 = (((__pyx_v_c_tau2 * __pyx_v_cc) + (__pyx_v_cs_tau * __pyx_v_cs)) + (__pyx_v_s_tau2 * __pyx_v_ss));
 ...
 * 
 */
    __pyx_t_22 = pow(((__pyx_v_c_tau * __pyx_v_xs) - (__pyx_v_s_tau * __pyx_v_xc)), 2.0);
 ...
 *             ((c_tau * xs - s_tau * xc)**2 / \
 */
    __pyx_t_6 = PyFloat_FromDouble((0.5 * ((__pyx_t_17 / __pyx_t_21) + (__pyx_t_22 / __pyx_t_23)))); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    if (unlikely(__Pyx_SetItemInt(__pyx_v_pgram, __pyx_v_i, __pyx_t_6, Py_ssize_t, 1, PyInt_FromSsize_t, 0, 1, 0) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 165; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  }

  /* "scipy/signal/_spectral.pyx":170
 *             (c_tau2 * ss - cs_tau * cs + s_tau2 * cc)))
 * 
 *     return pgram             # <<<<<<<<<<<<<<
 * 
 ...
 *     # Create empty array for output periodogram
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Input_arrays_do_not_have_the_sam); if (unlikely(!__pyx_tuple_)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 129; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(3, 0, 19, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_mnt_data_pauli_prj_scipy_scipy, __pyx_n_s_lombscargle, 19, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
